...
//    QCOMPARE(profiles->m_defaultAbsolutePanTiltPositionSpace[0],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/PositionGenericSpace"));
//    QCOMPARE(profiles->m_defaultAbsolutePanTiltPositionSpace[1],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/PositionGenericSpace"));
...
//    QCOMPARE(profiles->m_defaultRelativePanTiltTranslationSpace[0],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/TranslationGenericSpace"));
//    QCOMPARE(profiles->m_defaultRelativePanTiltTranslationSpace[1],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/TranslationGenericSpace"));
...
//    QCOMPARE(profiles->m_defaultContinuousPanTiltVelocitySpace[0],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/VelocityGenericSpace"));
//    QCOMPARE(profiles->m_defaultContinuousPanTiltVelocitySpace[1],QString("http://www.onvif.org/ver10/tptz/PanTiltSpaces/VelocityGenericSpace"));
